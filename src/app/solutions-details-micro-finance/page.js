    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 items-center px-2 pt-8 md:px-8 lg:px-16 xl:px-52 2xl:px-72">
          ...
          Home/solutions/details/micro-finance
          </p>
          <h3 className="text-2xl text-white md:text-4xl">Micro Finance</h3>
        </div>
      </section>
          ...
          <div className="col-span-2">
            ...
            <div>
              ...
              <div className="pb-10 border-b-2 border-gray-400">
                <p className="inline p-1 text-lg md:text-base md: rounded-2xl bg-custorm-purple">
              ...
              <div className="pt-4 pb-5 border-b-2 border-gray-400">
                <p className="inline p-1 text-lg rounded-2xl bg-custorm-purple">
                  COMMODITIES
                </p>
                <p className="pt-3 text-lg md:text-base">

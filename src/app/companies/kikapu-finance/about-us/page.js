    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 items-center px-2 pt-8 md:px-8 lg:px-16 xl:px-52 2xl:px-72">
          <p className="text-lg text-white md:text-base">kikapu-finance/about-us</p>
      ...
      <section className="py-24">
        <div className="flex justify-center">
          <div className="grid px-2 md:items-center md:gap-16 md:grid-cols-2 md:px-8 lg:px-16 xl:px-52 2xl:px-72">
            <div className="flex justify-center">
              <Image
            ...
            <div className="md:max-w-2xl">
              ...
              <h3 className="pb-5 text-4xl font-bold">

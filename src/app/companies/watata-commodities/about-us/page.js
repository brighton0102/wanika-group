...
import jobwell from "@/assets/images/jopwell.jpg";
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 items-center px-2 pt-8 md:px-8 lg:px-16 xl:px-52 2xl:px-72">
          <p className="text-lg text-white md:text-base">watata-commodities/about-us</p>
      ...
      <section className="py-24">
        <div className="flex justify-center">
          <div className="grid px-2 md:items-center md:grid-cols-2 md:gap-16 md:px-8 lg:px-16 xl:px-52 2xl:px-80">
            <div className="flex justify-center">
              <Image
      ...
      <section className="px-2 py-24 bg-white md:px-8 lg:px-16 xl:px-52 2xl:px-72">
        <div>
          <p className="pb-5 text-lg font-bold text-center md:text-base text-dark-blue">OUR VALUES</p>

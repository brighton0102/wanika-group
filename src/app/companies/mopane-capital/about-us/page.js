...
import roots03 from "@/assets/images/roots03.jpg";
import natalie from "@/assets/images/natalie.jpg";
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 items-center px-2 pt-8 md:px-8 lg:px-16 xl:px-52 2xl:px-72">
          <p className="text-lg text-white md:text-base">mopane-capital/about-us</p>
          ...
          <div className="grid items-center px-2 md:grid-cols-2 md:gap-16 md:px-8 lg:px-16 xl:px-52 2xl:px-72">
            <div className="flex justify-center">
              <Image
                ...
                src={natalie}
                width={600}
                height={500} // Add appropriate height to maintain aspect ratio
                alt="black suit"
              />
            </div>
            <div className="md:max-w-2xl">
              <p className="pt-5 pb-5 text-lg font-bold md:pt-0 md:text-base text-dark-brown">WHO WE ARE</p>
              <h2 className="pb-5 text-4xl font-semibold text-custorm-black">

...
const valuesData = [
  {
    ...
    description: "Expertise in securing funding through high-net-worth individuals and institutional investors for private equity and venture capital.",
  },
  {
    icon: <SlBriefcase className="p-2 text-5xl text-white rounded md:text-4xl bg-dark-brown" />,
    title: "Due Diligence",
    description: "Thorough independent assessments and risk management to enhance our structured finance solutions.",
  },
  {
  ...
  },
  {
    ...
    description: "Effective legal structuring and project selection through rigorous analysis and strategic partnerships.",
  },
  {
    icon: <SlGlobe className="p-2 text-5xl text-white rounded md:text-4xl bg-dark-brown" />,
    title: "Investment Opportunities",
    description: "Linking global investors with qualifying projects that meet high-impact investment criteria.",
  },
  {
    icon: <SlDiamond className="p-2 text-5xl text-white rounded md:text-4xl bg-dark-brown" />,
    title: "Impact Investing",
    description: "Focused on impact investing to drive sustainable growth and create value for investors and communities.",
  },
];
    ...
    <div className="grid items-center px-2 md:grid-cols-2 md:gap-16 md:px-8 lg:px-16 xl:px-52 2xl:px-56">
      ...
      <div className="md:max-w-2xl">
        ...
        <p className="p-4 pb-5 text-base italic border-l-4 bg-pine-brown border-dark-brown text-custorm-black">
          We specialize in capital raising and structured finance, connecting investors with high-impact opportunities.
        </p>
        <p className="pt-5 mb-5 text-base text-gray-500">
          Our team partners with Mopane Consultancy Services for thorough due diligence, risk management, and legal structuring, enhancing our capital raise initiatives and structured finance solutions.
        </p>
        <p className="pt-5 mb-5 text-base text-gray-500">
          We engage global markets, linking investors with high-return opportunities in Africa’s commodity trading, energy, and mining sectors through rigorous analysis and project selection.
        </p>
      </div>
    </div>
  </div>
      ...
      <section className="px-2 py-24 bg-white md:px-8 lg:px-16 xl:px-52 2xl:px-56">
        <div>
          <p className="pb-5 text-base font-bold text-center text-dark-brown">OUR VALUES</p>

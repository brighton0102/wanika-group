    ...
    <>
      <div className="col-span-2 md:col-span-2 lg:col-span-1">
            <Link href="/solutions-details-commodity-trading">
              <div className="flex items-center justify-between p-5 mb-4 rounded-md cursor-pointer bg-custorm-purple">
            ...
            <Link href="/solutions-details-structured-finance">
              <div className="flex items-center justify-between p-5 mb-4 rounded-md bg-custorm-purple">
            ...
            <Link href="/solutions-details-secretarial-service">
              <div className="flex items-center justify-between p-5 rounded-md bg-custorm-purple">

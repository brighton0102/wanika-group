  ...
  return (
    <div className="col-span-2 md:col-span-2 lg:col-span-1">
      <Link href="/solutions-details-commodity-trading">
        <div className="flex items-center justify-between p-5 mb-4 rounded-md cursor-pointer bg-custorm-purple hover:bg-custorm-yellow transition-colors duration-200">
      ...
      <Link href="/solutions-details-secretarial-service">
        <div className="flex items-center justify-between p-5 rounded-md cursor-pointer bg-custorm-purple hover:bg-custorm-yellow transition-colors duration-200">
          <p className="text-lg font-bold md:text-base">Secretarial Service</p>
          <IoIosArrowRoundForward className="text-3xl bg-white rounded-md" />
        </div>
      </Link>

      <div className="p-10 mt-4 bg-custorm-yellow">
